# Associate – SDE Role Assignment

Welcome to the assignment for candidates applying to the **Associate** position at **Viscadia**. This is a take-home evaluation designed to assess your technical depth, analytical thinking, and approach to solving real-world ETL and cloud infrastructure problems.
...
2. Download the input files from this [AWS S3](https://assessment-case-study-data.s3.us-east-1.amazonaws.com/Assignment_A/a_data.zip) link, which contains:
...
1. Write a SQL Procedure or Query that returns the top 3 selling products per region over the past 2 months.
